...
print(f"Nilai rata-rata dari data {data} adalah {mean}")
print(f"Nilai variance dari data {data} adalah {var}")
print(f"Nilai standart deviation dari data {data} adalah {std}")
